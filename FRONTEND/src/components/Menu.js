  ...
  return <section className='min-h-[780px] '>
    ...
    <div className='relative z-10 top-72 lg:top-52'>
      <motion.div variants={staggerContainer}
        ...
        <motion.h2 variants={fadeIn('down', 'tween', 0.2, 1.6)} className='h2 capitalize text-white max-w-[800px] text-center'>{title}</motion.h2>
        <motion.p variants={fadeIn('down', 'tween', 0.4, 1.6)} className=' text-white/70 capitalize mb-8'>{subtitle}</motion.p>
        <motion.div variants={fadeIn('down', 'tween', 0.5, 1.6)}>
                ...
                <div className='flex flex-row lg:flex-col h-full'>
                  ...
                  <div className='bg-[#fff3e4] flex-1 flex flex-col justify-center px-6 lg:p-12 lg:max-h-[250px] xl:max-h-max'>
                    <div className='text-center'>
                      <div className='text-xl font-third font-semibold text-dark xl:text-2xl'>{name}</div>
                      <div className='my-1 text-[20px] lg:text-[30px] lg:my-6 text-accent font-third font-semibold'>{price}</div>
                      <div className='font-third'>{description}</div>
                    </div>
                  </div>
                </div>
              </div>
